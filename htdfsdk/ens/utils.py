...
from htdfsdk.ens.constants import (
...
from htdfsdk.ens.exceptions import (
    InvalidName,
)
...
if TYPE_CHECKING:
    from htdfsdk.web3 import Web3 as _Web3  # noqa: F401
    from htdfsdk.web3.providers import (  # noqa: F401
        BaseProvider,
    )


def Web3() -> Type['_Web3']:
    from htdfsdk.web3 import Web3 as Web3Main
    return Web3Main
...
def customize_web3(w3: '_Web3') -> '_Web3':
    from htdfsdk.web3.middleware import make_stalecheck_middleware
